...
namespace BMS
{
    public partial class frmStaffGroup : _Forms
    {
        ...
        private void LoadData()
        {
            try
            {
                DataTable tbl = TextUtils.Select("Select * from vUserGroup with(nolock)");
        ...
        void loadLeader()
        {
            DataTable dt = TextUtils.Select("select * from Users with(nolock) order by Code");
            cboLeader.Properties.DataSource = dt;
            cboLeader.Properties.ValueMember = "ID";
            cboLeader.Properties.DisplayMember = "Name";
        }
        #endregion
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            cboLeader.EditValue = dModel.Leader;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                if (checkValid())
                {
                    ...
                    dModel.Leader = TextUtils.ToInt(cboLeader.EditValue);
                    if (isAdd)
                    {
