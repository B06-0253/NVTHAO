...
namespace BMS
{
    public partial class frmShowStaff : _Forms
    {
        ...
        private bool ValidateForm()
        {
            ...
            {
                 MessageBox.Show("Bạn phải chọn một trạng thái!", TextUtils.Caption, MessageBoxButtons.OK, MessageBoxIcon.Stop);
                return false;
            }
            return true;
        }
        ...
        void loadGroupQLSX()
        {
            ...
            cboGroup.Properties.DataSource = tbl;
        ...
        private void btnAddGroup_Click(object sender, EventArgs e)
        {
            ...
            foreach (int i in gridView1.GetSelectedRows())
            {
                ...
                DataTable dtLink = TextUtils.Select("select top 1 * from UserGroupLink with(nolock) where UserID = " + userID
