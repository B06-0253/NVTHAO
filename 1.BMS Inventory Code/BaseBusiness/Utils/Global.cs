...
namespace BMS
{
    public static class Global
    {
        ...
        static string _ConnectionString = "Server=192.168.20.252;Database=QLKHCV;uid=sa;pwd=123@123a;";
        //static string _ConnectionString = @"Server=MRTHAO-PC\SQLEXPRESS;Database=QLKHCV;uid=sa;pwd=123@123a;";
